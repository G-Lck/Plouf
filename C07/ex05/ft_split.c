...
/*   Updated: 2025/07/09 15:21:42 by glucken          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*  int	main(void)
{
	...
	char **split;
	split = malloc(sizeof(char*) * (count_words(str, charset) + 1));
	printf("str_len de rien: %d\n", ft_strlen_s(str, "\0"));
	split[0] = malloc(sizeof(char) * ft_strlen_s(str, charset) + 1);
	split[0] = NULL;
	
	printf("%s\n", ft_split("a-ab-abc-abcd", "-")[0]);
	printf("%s\n", ft_split("a-ab-abc-abcd", "")[0]);
	printf("%p\n", ft_split("", "-")[0]);
	printf("%p\n", ft_split("", "")[0]);
	printf("%s\n", ft_split("a-ab-abc-abcd", "-")[0]);
	printf("%s\n", ft_split("a-ab-abc-abcd", "-")[1]);
	printf("%s\n", ft_split("a-ab-abc-abcd", "-")[2]);
	printf("%s\n", ft_split("a-ab-abc-abcd", "-")[3]);
	printf("%s\n", ft_split("a", "c")[0]);
	printf("%d\n", count_words("abc", " "));
	return (0);
} */